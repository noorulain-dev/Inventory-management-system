...
<hmtl lang="en">
    ...
    <body>
        ...
        <h2 class="text-center" style=" font-size: 45px; font-family: 'Untitled Serif',Georgia,Moderat,Helvetica Neue,Helvetica,Arial,sans-serif; font-weight: 700; font-style: normal; text-rendering: optimizeLegibility; padding-top: 30px;">Footwear</h2>
        <hr class="col-9 mx-auto" style="border-top: 3px double;">
...
$query = "SELECT products.*, users.first_name, users.last_name 
FROM products 
            ...
            <div class="card h-100">
                <a href="product_details.php?id=<?php echo $product['product_ID']; ?>">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Display seller's first and last name -->
                        <p class="seller-name">Seller: <?php echo $product['first_name'] . ' ' . $product['last_name']; ?></p>
