...
<hmtl lang="en">
    ...
    <body>
        ...
        <h2 class="text-center" style=" font-size: 45px; font-family: 'Untitled Serif',Georgia,Moderat,Helvetica Neue,Helvetica,Arial,sans-serif; font-weight: 700; font-style: normal; text-rendering: optimizeLegibility; padding-top: 30px;">Products on Sale</h2>
        <hr class="col-9 mx-auto" style="border-top: 3px double;">
